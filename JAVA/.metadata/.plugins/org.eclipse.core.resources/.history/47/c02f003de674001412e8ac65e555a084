...
public class QuestionSelectionFactory {
	...
	public static QuestionSelectionFactory getInstance(QuestionSelectionbehaviour qsb) throws DomainException{
		if(singleton == null){
	...
	private QuestionSelectionFactory(QuestionSelectionbehaviour qsb) throws DomainException {
	...
	private void setQuestionSelectionbehaviour(QuestionSelectionbehaviour questionSelectionbehaviour) throws DomainException {
